...
class MilkyHttpClient {
  ...
  Future<Either<String, MilkyHttpClientResponse<T>>> _run<T>(
    ...
    try {
      ...
      /// if you get errors or code does not work properly check dioError on catch
    } on DioException catch (dioError) {
      // _logError(dioError.message);
      _logError(dioError.response?.data.toString());
  ...
  String _getDioErrorResponseMessage(final Response<dynamic>? response) {
  ...
  String _getErrorKey(final DioException dioException) {
    ...
    switch (dioException.type) {
      case DioExceptionType.badResponse:
        return _getDioErrorResponseMessage(dioException.response);
